 ...
 */
public class ClassifyTwoFactionsEvent extends AbstractMapFunction {
	...
	public ClassifyTwoFactionsEvent() {
		super();
	}

	public ClassifyTwoFactionsEvent(String options) throws IOException {
		super(options);
