...
public class GeoUtils {
	...
	public static Shape getPointxx(String pointString) {
		String[] values = pointString.split(" ");
		return ctx.makePoint(Double.parseDouble(values[0]), Double.parseDouble(values[1]));
	}
	
	public static Shape getPoint(String pointString, String separator) {
