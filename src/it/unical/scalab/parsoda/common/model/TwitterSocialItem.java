...
public class TwitterSocialItem extends SocialItem {
	...
	public TwitterSocialItem(String json) throws JSONException, TwitterException {
		super(new JSONObject(json));
	}

	public TwitterSocialItem(JSONObject json) {
		super(json);
	}
