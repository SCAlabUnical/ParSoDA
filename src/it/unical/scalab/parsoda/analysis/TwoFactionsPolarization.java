...
public class TwoFactionsPolarization extends AbstractAnalysisFunction {

	String outputFileName = "/TwoFactionsPolarization.txt";
	double threshold = 0.9;
	HashMap<Integer, Integer> counter = new HashMap<Integer, Integer>();

	public TwoFactionsPolarization() {
		super();
	}

	public TwoFactionsPolarization(String options) {
		super(options);
	...
	public void prepareData() {
		try {
			...
			String[] parts = null;
			double pol = 0.0;
			int labelPosition = 0; // 0=Neutral; 1=Positive; 2=Negative
